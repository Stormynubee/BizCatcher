# BizCatch by The Developer

BizCatch helps find local businesses by location, inspect whether they list a website, mark outreach status, and export filtered leads to CSV.
